 ...
 */
class FlightRoutes(registry: ActorRef[RegistryCommand])(implicit system: ActorSystem[_]) extends FlightJsonProtocol {
                ...
                case Right((flight, _)) =>
                  ...
                  onSuccess(futureResponse) {
                    case RegistryFlightCreated(created) =>
                      complete(StatusCodes.Created, FlightDtoMapper.toResponse(created))
          ...
          get {
            ...
            onSuccess(futureResponse) {
              case FlightsRetrieved(flights) =>
                complete(StatusCodes.OK, FlightDtoMapper.toListResponse(flights))
              case _ =>
