...
object Logging {
  ...
  implicit class RichLogger(logger: Logger) {
    ...
    def debugWithContext(message: String)(implicit
        context: CorrelationContext
    ): Unit =
      CorrelationId.withContext(context)(logger.debug(message))

    def debugWithContext(message: String, args: Any*)(implicit
        context: CorrelationContext
    ): Unit =
    ...
    def infoWithContext(message: String)(implicit
        context: CorrelationContext
    ): Unit =
      CorrelationId.withContext(context)(logger.info(message))

    def infoWithContext(message: String, args: Any*)(implicit
        context: CorrelationContext
    ): Unit =
      CorrelationId.withContext(context)(
    ...
    def warnWithContext(message: String)(implicit
        context: CorrelationContext
    ): Unit =
      CorrelationId.withContext(context)(logger.warn(message))

    def warnWithContext(message: String, args: Any*)(implicit
        context: CorrelationContext
    ): Unit =
      CorrelationId.withContext(context)(
    ...
    def errorWithContext(message: String)(implicit
        context: CorrelationContext
    ): Unit =
      CorrelationId.withContext(context)(logger.error(message))

    def errorWithContext(message: String, args: Any*)(implicit
        context: CorrelationContext
    ): Unit =
      CorrelationId.withContext(context)(
    ...
    def errorWithContext(message: String, throwable: Throwable)(implicit
        context: CorrelationContext
    ): Unit =
