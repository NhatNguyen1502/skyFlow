-- default schema for Akka Persistence JDBC plugin: 
-- https://github.com/akka/akka-persistence-jdbc/blob/v5.5.4/core/src/main/resources/schema/postgres/postgres-create-schema.sql
